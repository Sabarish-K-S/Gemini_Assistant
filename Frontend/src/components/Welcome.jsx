...
import lcLogo from '../assets/lcphoto.png'
  ...
  return (
    ...
    <div className='wrapper'>
      ...
      <div className='right-view'>
        ...
        <h3>I’ve built my own AI Assistant using the Gemini API (model: gemini-2.5-flash-lite), for Frontend I used ReactJS and for Backend API layer I used Spring Boot. Since it is a free tier API key so it has usage limits (Usage limits: 15 requests/min, 250k tokens/min, 1,000 requests/day.)<span className='bold'><bold> &nbsp;SO PLEASE USE IT LIMITEDLY&nbsp;</bold></span></h3>
    ...
    <div className='About' ref={target}><br/>
      ...
      <div className='wrapperLC'>
        <div className='lcdiv'>
          <img className='lcImage' src={lcLogo}/>
